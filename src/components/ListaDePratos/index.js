...
function ListaDePratos() {
    ...
    return (
        ...
        <div className="container-lista">
            ...
            <strong>Nome: </strong><h3 className="nome-prato"> {prato.nomeprato}</h3><br />
            <strong>Descrição: </strong><i>{prato.descricao}</i><br />
            <strong>Preço: </strong><i>{prato.preco} R$</i><br />
